        ...
        if(e.target.id.includes("instrucciones")){
            ...
            MySwal.fire({
                ...
                html: <p> <strong>Te damos la bienvenida a este simulador de la Maquina de Turing</strong> <br/><br/>
                        ...
                        ➤ Te permitira ingresar una cadena con combinaciones cualesquiera de a y b en minúscula. <br/><br/>
                        ➤ Luego debes cargar la máquina para la simulación (La cadena que escribiste se ubicara en la cinta). <br/><br/>
                        ➤ Posterior a ello tendras que seleccionar el modo en que deseas ver el proceso, puedes hacerlo paso a paso 
                        de forma manual o puedes dejar que la simulación sea automática, en caso de que optes por esta ultima opción 
                        tendras que establecer una velocidad de simulación en el slider, la máxima son 300 milisegundos y la mínima son 1000.<br/><br/> 
                        ➤ Puedes cambiar de modo automático a manual y viceversa. <br/><br/>
                        ➤ Al dar click en los botones de "iniciar" y "siguiente" de cada modo podras notar que la simulación convierte la cadena de 
